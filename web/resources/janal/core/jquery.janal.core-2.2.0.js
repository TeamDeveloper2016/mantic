  ...
  Janal.Control.Functions= Class.extend({
    ...
    init: function(root) {
      ...
      if(typeof(root)!== 'undefined')
        this.root   = root;
      $self.load(0, ['/resources/janal/core/jquery.shortcut.core.0.1.1.js','/resources/janal/core/jquery.janal.sticky.min-1.0.0.js','/resources/janal/js/jquery.janal.menu-2.0.1.js','/resources/janal/core/jquery.longclick-1.0.0.js', '/resources/janal/core/jquery.validate.min-1.15.0.js', '/resources/janal/core/jquery.meio.mask.min-1.1.15.js', '/resources/janal/core/jquery.janal.fns-1.3.2.js']);
