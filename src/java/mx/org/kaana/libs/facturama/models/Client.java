...
public class Client {
  ...
  public String toString() {
    return "Client{" + "Id=" + Id + ", Email=" + Email + ", EmailOp1=" + EmailOp1 + ", EmailOp2=" + EmailOp2 + ", Address=" + Address + ", Rfc=" + Rfc + ", Name=" + Name + ", CfdiUse=" + CfdiUse + ", FiscalRegime=" + FiscalRegime + ", TaxZipCode=" + TaxZipCode + ", TaxResidence=" + TaxResidence + ", NumRegIdTrib=" + NumRegIdTrib + '}';
  }
