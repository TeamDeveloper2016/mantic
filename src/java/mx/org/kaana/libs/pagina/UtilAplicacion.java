...
public class UtilAplicacion {
  ...
  private static final String CSS   = "janal.mantic.core-0.4.2.css";
  private static final String CORE  = "jquery.janal.core-2.8.5.js";
  private static final String VENTAS= "jquery.janal.ventas.core-0.6.7.js";
	private static final String TICKET= "jquery.janal.ticket.core-0.0.3.js";
  private static final String CALC  = "jquery.janal.arts.core-2.1.0.js";
  private static final String KARDEX= "jquery.janal.kardex.core-0.4.3.js";
  private static final String DLGS  = "jquery.janal.precio.core-0.3.8.js";
  ...
  public String getDefaultCss() {
    StringBuilder sb = new StringBuilder();
    String[] css = {"sentinel-core-1.0.2.css|sentinel", "sentinel-font-icon-1.0.0.css|sentinel", "sentinel-layout-1.0.1.css|sentinel", CSS.concat("|janal")};
    for (String item : css) {
