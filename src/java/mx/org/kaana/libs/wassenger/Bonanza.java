...
public final class Bonanza implements Serializable {
  ...
  private static final String BODY_CONTEOS        = "\"phone\":\"+521{celular}\",\"message\":\"Hola _{nombre}_,\\n\\n{saludo}, te notificamos que C. *{usuario}* ya envió el requerimiento con folio [*{ticket}*] y nombre [*{fecha}*] para contabilizar *{reporte}* producto(s) o articulo(s), para tu conocimiento y revisión en la aplicación web.\\n\\n*_{empresa}_*\"";
  private static final String BODY_CONTEOS_DESTINO= "\"phone\":\"+521{celular}\",\"message\":\"Hola _{nombre}_,\\n\\n{saludo}, te notificamos que has recibido el requerimiento con folio [*{ticket}*] y nombre [*{fecha}*] por parte de C. *{usuario}* para contabilizar *{reporte}* producto(s) o articulo(s), favor de ingresar a la aplicación móvil para atender este requerimiento.\\n\\n*_{empresa}_*\"";
  private static final String BODY_CONTEOS_FUENTE = "\"phone\":\"+521{celular}\",\"message\":\"Hola _{nombre}_,\\n\\n{saludo}, te notificamos que C. *{usuario}* fue notificado para atender el requerimiento con folio [*{ticket}*] y nombre [*{fecha}*] para contabilizar *{reporte}* producto(s) o articulo(s), para tu conocimiento y seguimiento.\\n\\n*_{empresa}_*\"";

  private static final String BODY_SOLICITUD        = "\"phone\":\"+521{celular}\",\"message\":\"Hola _{nombre}_,\\n\\n{saludo}, te notificamos que C. *{usuario}* ya envió la solicitud con folio [*{ticket}*] de *{reporte}* producto(s) o articulo(s), para tu conocimiento y revisión en la aplicación web.\\n\\n*_{empresa}_*\"";
  private static final String BODY_SOLICITUD_FUENTE = "\"phone\":\"+521{celular}\",\"message\":\"Hola _{nombre}_,\\n\\n{saludo}, te notificamos que fueron notificados los usuarios para atender la solicitud con folio [*{ticket}*] con *{reporte}* producto(s) o articulo(s), para tu conocimiento y seguimiento.\\n\\n*_{empresa}_*\"";
  private static final String BODY_SOLICITUD_DESTINO= "\"phone\":\"+521{celular}\",\"message\":\"Hola _{nombre}_,\\n\\n{saludo}, te notificamos que has recibido *la solictud* con folio [*{ticket}*] por parte de C. *{usuario}* para transferir *{reporte}* producto(s) o articulo(s), favor de ingresar a la aplicación móvil para atender este requerimiento.\\n\\n*_{empresa}_*\"";
