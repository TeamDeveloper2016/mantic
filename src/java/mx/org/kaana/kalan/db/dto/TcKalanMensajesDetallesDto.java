...
@Entity
@Table(name="tc_kalan_mensajes_detalles")
public class TcKalanMensajesDetallesDto implements IBaseDto, Serializable {
  ...
  public TcKalanMensajesDetallesDto() {
    this(new Long(-1L));
  }

  public TcKalanMensajesDetallesDto(Long key) {
    this(new Long(-1L), null, null, null);
    setKey(key);
  }

  public TcKalanMensajesDetallesDto(Long idMensajeDetalle, Long idCliente, Long idMensaje, String celular) {
  ...
  public Class toHbmClass() {
    return TcKalanMensajesDetallesDto.class;
  }
  ...
  public boolean equals(Object obj) {
    ...
    final TcKalanMensajesDetallesDto other = (TcKalanMensajesDetallesDto) obj;
