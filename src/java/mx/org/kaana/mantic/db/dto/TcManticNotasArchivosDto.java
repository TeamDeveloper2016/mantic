...
public class TcManticNotasArchivosDto implements IBaseDto, Serializable {
  ...
  public Object[] toArray() {
    Object[] regresar = new Object[] {
      getIdNotaArchivo(), getRuta(), getTamanio(), getIdUsuario(), getIdTipoArchivo(), getAlias(), getMes(), getIdNotaEntrada(), getNombre(), getArchivo(), getObservaciones(), getEjercicio(), getIdPrincipal(), getIdTipoDocumento(), getIdEliminado(), getRegistro()
    };
    return regresar;
  }
