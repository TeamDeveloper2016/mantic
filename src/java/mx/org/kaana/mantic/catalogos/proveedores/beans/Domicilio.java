...
public class Domicilio extends TrManticProveedorDomicilioDto implements Serializable, IBaseAction, Cloneable {
  ...
  @Override
  public Object clone()  {
    Domicilio cloned = (Domicilio) super.clone();
    try {
      cloned.setTcManticDomicilioDto((TcManticDomiciliosDto)cloned.getTcManticDomicilioDto().clone());
    }
