...
public class ProveedorDomicilio extends TrManticProveedorDomicilioDto{
	...
	public ProveedorDomicilio() {
		this(-1L);
	}

	public ProveedorDomicilio(Long key) {
		this(key, ESql.UPDATE);
	}
	
	public ProveedorDomicilio(Long key, ESql sqlAccion) {
		this(key, sqlAccion, false);
	}
	
	public ProveedorDomicilio(Long key, ESql sqlAccion, Boolean nuevo) {		
		this(key, sqlAccion, nuevo, 0L, false, null, null, null, null, null, null, null, null, null, null, null, false);
	}
	
	public ProveedorDomicilio(Long key, ESql sqlAccion, Boolean nuevo, Long consecutivo, Boolean modificar, Entity idEntidad, Entity idMunicipio, Entity idLocalidad, Entity domicilio, String codigoPostal, String calle, String exterior, String interior, String colonia, String entreCalle, String yCalle, boolean nuevoCp) {		
		super(key);
