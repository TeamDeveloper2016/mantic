...
//										articulo.setIdEmpaqueUnidadMedida(this.toFindUnidadMedida(sesion, sheet.getCell(7, fila).getContents()));
									...
									articulo= new TcManticArticulosDto(
										...
										costo, // Double precio, 
										iva, // Double iva, 
										Numero.toAjustarDecimales(mayoreo, articulo.getIdRedondear().equals(1L)), // Double mayoreo, 
										2D, // Double desperdicio, 
										null, // String metaTagDescipcion, 
										1L, // Long idVigente, 
										-1L, // Long idArticulo, 
										0D, // Double stock, 
										Numero.toAjustarDecimales(medio, articulo.getIdRedondear().equals(1L)), // Double medioMayoreo, 
										0D, // Double pesoEstimado, 
										this.toFindUnidadMedida(sesion, sheet.getCell(7, fila).getContents()), // Long idEmpaqueUnidadMedida, 
										1L, // Long idRedondear, 
										Numero.toAjustarDecimales(menudeo, articulo.getIdRedondear().equals(1L)), // Double menudeo, 
