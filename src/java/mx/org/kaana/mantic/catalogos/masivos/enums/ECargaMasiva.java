...
public enum ECargaMasiva implements Serializable {
	...
	REFACCIONES(4L, "CODIGO|NOMBRE|HERRAMIENTA|COSTONETO|IVA|SAT|RFC|CLAVEPROVEEDOR", "CODIGO,NOMBRE,HERRAMIENTA,COSTO NETO,IVA,SAT,RFC,CLAVE PROVEEDOR", 8, 500, "masivo-refacciones.xls"),
	SERVICIOS(5L, "CODIGO|NOMBRE|COSTONETO|IVA|SAT|LINEA", "CODIGO,NOMBRE,COSTO NETO,IVA,SAT,LINEA", 6, 100, "masivo-servicios.xls"),
