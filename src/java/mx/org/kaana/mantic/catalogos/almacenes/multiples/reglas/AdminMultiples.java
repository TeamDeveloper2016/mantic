...
public final class AdminMultiples extends IAdminArticulos implements Serializable {
	...
	public AdminMultiples(Multiple orden) throws Exception {
  	  ...
  	  this.setArticulos((List<Articulo>)DaoFactory.getInstance().toEntitySet(Articulo.class, "VistaTransferenciasMultiplesDto", "detalle", orden.toMap(), Constantes.SQL_TOPE_REGISTROS));
