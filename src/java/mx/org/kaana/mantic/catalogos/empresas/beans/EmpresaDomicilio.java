...
public class EmpresaDomicilio extends TrManticEmpresaDomicilioDto implements Serializable{

	private static final long serialVersionUID = -4532252314310769792L;
	...
	public EmpresaDomicilio() {
		this(-1L);
	}

	public EmpresaDomicilio(Long key) {
		this(key, ESql.UPDATE);
	}
	
	public EmpresaDomicilio(Long key, ESql sqlAccion) {
		this(key, sqlAccion, false);
	}
	
	public EmpresaDomicilio(Long key, ESql sqlAccion, Boolean nuevo) {		
		this(key, sqlAccion, nuevo, 0L, false, null, null, null, null, null, null, null, null, null, null, null, false);
	}
	
	public EmpresaDomicilio(Long key, ESql sqlAccion, Boolean nuevo, Long consecutivo, Boolean modificar, Entity idEntidad, Entity idMunicipio, Entity idLocalidad, Entity domicilio, String codigoPostal, String calle, String exterior, String interior, String colonia, String entreCalle, String yCalle, boolean nuevoCp) {		
		super(key);
