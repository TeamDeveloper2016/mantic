...
public enum EReportes implements IReportAttribute{
	...
	ORDEN_DETALLE_DIF   ("VistaReportesOrdenesComprasDto", "diferenciasOrdenCompra", "Orden de compra detalle diferencias", "/Paginas/Mantic/Compras/Ordenes/Reporte/ordenDetalleDiferencias", EFormatos.PDF, "orden_de_compra_diferencias_detalle", "/Paginas/Mantic/Compras/filtro"),
