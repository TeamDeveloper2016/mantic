...
public enum EReportes implements IReportAttribute{
  ...
  CONFTONTAS("VistaConfrontasDto", "confronta", "Confrontas", "/Paginas/Mantic/Catalogos/Almacenes/Confrontas/Reportes/confrontas", EFormatos.PDF, "confrontas", "/Paginas/Mantic/Catalogos/Almacenes/Confrontas/filtro"),
	CONFTONTAS_DETALLE("VistaConfrontasDto", "consulta", "Confronta", "/Paginas/Mantic/Catalogos/Almacenes/Confrontas/Reportes/confrontasDetalle", EFormatos.PDF, "confronta_detalle", "/Paginas/Mantic/Catalogos/Almacenes/Confrontas/filtro"),
