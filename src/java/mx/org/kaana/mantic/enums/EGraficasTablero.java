...
public enum EGraficasTablero {
  ...
  static {
	...
	private EGraficasTablero(String tituloGeneral, String tituloLadox, String aliasLadox, String tituloLadoy, String aliasLadoy, String idVista, String descripcion, ETipoGrafica tipoChart, String height, Integer sizeY, Integer numColumnas, Long records) {
