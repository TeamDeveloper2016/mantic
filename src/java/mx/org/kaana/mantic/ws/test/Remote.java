...
//    Object[] params= {1976L, "1", "/Eb1AjylyNNfQBLodn6Jf6Stb8NM7Hw2", 2L};
//    Conteos conteos= new Conteos("mercurio", params);
//    System.out.println(conteos.getBeanRespuesta());
//    Conteos conteos= new Conteos("asteroide", params);
//    System.out.println(conteos.getBeanRespuesta());
...
//    System.out.println(conteos.getBeanRespuesta());
    ...
    Object[] params= {1L, "19000101", "/Eb1AjylyNNfQBLodn6Jf6Stb8NM7Hw2"};
    Conteos conteos= new Conteos("mercurio", params);
    System.out.println(conteos.getBeanRespuesta());
