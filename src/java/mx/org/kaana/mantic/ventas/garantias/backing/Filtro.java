...
public class Filtro extends IBaseFilter implements Serializable {
  ...
  protected void init() {
    try {
      ...
      this.attrs.put("sortOrder", "order by tc_mantic_garantias.id_empresa, tc_mantic_garantias.ejercicio, tc_mantic_garantias.orden");
			toLoadCatalog();
	...
	protected Map<String, Object> toPrepare() {
	  Map<String, Object> regresar= new HashMap<>();	
		...
		if(!Cadena.isVacio(this.attrs.get("fechaTermino")))
		  sb.append("(date_format(tc_mantic_garantias.registro, '%Y%m%d')<= '").append(Fecha.formatear(Fecha.FECHA_ESTANDAR, (Date)this.attrs.get("fechaTermino"))).append("') and ");	
