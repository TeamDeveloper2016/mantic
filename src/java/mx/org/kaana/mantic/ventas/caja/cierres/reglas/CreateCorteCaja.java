...
public class CreateCorteCaja {
	...
	private String toHeader() throws Exception{
		...
		regresar.append("<td><p style=\"text-align: center;align-content: center;font-family: sans-serif;font-size: 12px;font-weight: bold;\">");
	...
	private String toFindDomicilio() throws Exception{
		...
		try {
			params= new HashMap<>();
			params.put("idEmpresa", this.corte.getResumenCorte().toString("idEmpresa"));
    ...
    regresar.append("<br>");		
    //aqui es el id_usuario ligado al cierre pero creo debo sacar los de todas las ventas de la caja por que pudo haber mas de un cajero en el cierre para a misma caja
  ...
  private String toDevolucionesGarantias() throws Exception{
    ...
    if(this.corte.getGarantias().size()>0){
      for(Entity garantia : this.corte.getGarantias()){
        regresar.append("<tr>");
        regresar.append("<td style=\"font-family: sans-serif;font-size: 10px;width: 145px; max-width: 98px;\">").append(garantia.toString("consecutivo")).append("</td>");
  ...
  private String toRetirosIngresos() throws Exception{
    ...
    regresar.append("<p style=\"width: 290px;text-align: center;align-content: center;font-family: sans-serif;font-size: 12px;font-weight: bold;line-height:0px\">");
		...
		regresar.append("</p>");
    regresar.append("<p style=\"width: 290px;text-align: center;align-content: center;font-family: sans-serif;font-size: 10px;line-height:0px;\">");
    regresar.append("Folio retiros ").append(this.corte.getResumenCorte().toString("retiroInicial")).append(" al ").append(this.corte.getResumenCorte().toString("retiroFinal"));		
		regresar.append("<br>").append("</p>");
    regresar.append("<p style=\"width: 290px;text-align: center;align-content: center;font-family: sans-serif;font-size: 10px;line-height:0px;\">");
    regresar.append("Folio ingreso ").append(this.corte.getResumenCorte().toString("abonoInicial")).append(" al ").append(this.corte.getResumenCorte().toString("anonoFinal"));		
		regresar.append("<br>").append("</p>");
    regresar.append("<br>");
    regresar.append("<p style=\"width: 290px;text-align: left;align-content: center;font-family: sans-serif;font-size: 10px;\">");
    ...
    if(this.corte.getGarantias().size()>0){
      for(Entity abono : this.corte.getAbonos()){
        regresar.append("<tr>");
        regresar.append("<td style=\"font-family: sans-serif;font-size: 10px;width: 145px; max-width: 98px;\">").append(abono.toString("consecutivo")).append("</td>");
        regresar.append("<td align=\"center\" style=\"font-family: sans-serif;font-size: 10px;width: 96px; max-width: 96px;\">").append(" por ").append("</td>");
    ...
    if(this.corte.getGarantias().size()>0){
      for(Entity retiro : this.corte.getRetiros()){
        regresar.append("<tr>");
        regresar.append("<td style=\"font-family: sans-serif;font-size: 10px;width: 58px; max-width: 58px;\">").append(retiro.toString("consecutivo")).append("</td>");
        regresar.append("<td align=\"center\" style=\"font-family: sans-serif;font-size: 10px;width: 58px; max-width: 58px;\">").append(" por ").append("</td>");
        regresar.append("<td align=\"right\" style=\"font-family: sans-serif;font-size: 10px;width: 58px; max-width: 58px;\"> $  ").append(retiro.toString("importe")).append("</td>");
        regresar.append("<td align=\"left\" style=\"font-family: sans-serif;font-size: 10px;width: 58px; max-width: 58px;\">Concepto:  ").append(retiro.toString("concepto")).append("</td>");
        regresar.append("<td align=\"left\" style=\"font-family: sans-serif;font-size: 8px;width: 58px; max-width: 58px;\">Observación:  ").append(retiro.toString("observaciones")).append("</td>");
        regresar.append("</tr>");
      } // for	
    }
    else{
