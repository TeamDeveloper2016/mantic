...
public class CreateTicket {
	...
	private String toHeader(){
		...
		String image          = null;
		try {
			ticket= this.principal.getTicket()!= null ? this.principal.getTicket() : "";
			...
			regresar.append("<td><p style=\"text-align: center;align-content: center;font-size: 14px;\">").append(this.principal.getTitulo()).append("<br/>").append(ticket).append("</p></td>");
	...
	private String toBlackBar(){
		...
		try {
			...
			regresar.append("<p style=\"width: 290px;text-align: center;font-size: 13px;font-weight: bold;background: black;color: white\">CENTRO DE SERVICIO DEWALT Y B&amp;D</p>");
		} // try
		catch (Exception e) {			
			throw e;
		} // catch		
	...
	private String toDomicilio() throws Exception{
		...
		try {
			regresar= new StringBuilder();
			regresar.append("<p style=\"width: 290px;text-align: center;font-size: 14px;\">").append(toFindDomicilio()).append("</p>");
		} // try
		catch (Exception e) {			
			throw e;  
		} // catch		
	...
	private String toNoTicket(){
		...
		try {			
			...
			regresar.append("<p style=\"width: 290px;text-align: center;align-content: center;font-size: 15px;font-weight: bold\">TICKET No: ").append(this.principal.getClave()).append("-").append(descripcionTicket).append("</p>");
		} // try
		catch (Exception e) {			
			throw e;
		} // catch		
	...
	private String toTipoTransaccion(){
		...
		try {
			regresar= new StringBuilder();
			regresar.append("<p style=\"width: 290px;text-align: center;align-content: center;font-size: 13px;font-weight: bold\">").append(this.tipoTransaccion).append("</p>");
		} // try
		catch (Exception e) {			
			throw e;
		} // catch		
	...
	private String toFecha(){
		...
		try {
			regresar= new StringBuilder();
			regresar.append("<p style=\"width: 290px;text-align: center;align-content: center;font-size: 13px;\">Fecha:").append(Fecha.formatear(Fecha.FECHA_HORA_CORTA, ((TicketVenta)this.ticket.getOrden()).getRegistro())).append("</p>");
		} // try
		catch (Exception e) {			
			throw e;
		} // catch		
	...
	private String toHeaderTable(){
		...
		try {
			...
			regresar.append("<th style=\"font-size: 12px;width: 80px; max-width: 80px;border-top: 1px solid black;border-collapse: collapse;text-align: left\">CONCEPTO</th>");
			regresar.append("<th style=\"font-size: 12px;width: 35px;max-width: 35px;word-break: break-all;border-top: 1px solid black;border-collapse: collapse;text-align: center\">CANT</th>");
			regresar.append("<th style=\"font-size: 12px;width: 35px;max-width: 45px;word-break: break-all;border-top: 1px solid black;border-collapse: collapse;\">NETO</th>");
			regresar.append("<th style=\"font-size: 12px;width: 55px;max-width: 45px;word-break: break-all;border-top: 1px solid black;border-collapse: collapse;\">IMPORTE</th>");
	...
	private String toArticulos(){
		...
		try {
			...
			for(Articulo articulo : this.ticket.getArticulos()){
				...
				regresar.append("<tr style=\"border-top: 1px solid black;border-collapse: collapse;\">");
				regresar.append("<td style=\"font-size: 12px;width: 80px; max-width: 80px;border-top: 1px solid black;border-collapse: collapse;\">").append(pivote.getNombre()).append("</td>");
				regresar.append("<td style=\"font-size: 12px;width: 35px;max-width: 35px;word-break: break-all;border-top: 1px solid black;border-collapse: collapse;text-align: center\">").append(pivote.getCantidad()).append("</td>");
				regresar.append("<td style=\"font-size: 12px;width: 35px;max-width: 45px;word-break: break-all;border-top: 1px solid black;border-collapse: collapse;text-align: right\">").append(pivote.getPrecio()).append("</td>");
				regresar.append("<td style=\"font-size: 12px;width: 55px;max-width: 45px;word-break: break-all;border-top: 1px solid black;border-collapse: collapse;text-align: right\">").append(pivote.getImporte()).append("</td>");
				regresar.append("</tr>");
			} // for
	...
	private String toPagos(){
		...
		try {
			...
			regresar.append("<td style=\"font-size: 12px;width: 70px;max-width: 35px;word-break: break-all;border-collapse: collapse;\"></td>");			
			regresar.append("<td style=\"font-size: 12px;width: 35px; max-width: 80px;border-collapse: collapse;\"></td>");			
			regresar.append("<td style=\"font-size: 12px;width: 55px;max-width: 45px;word-break: break-all;border-collapse: collapse;text-align: right;\">SUBTOTAL:</td>");			
			regresar.append("<td style=\"font-size: 12px;width: 45px;max-width: 45px;word-break: break-all;border-collapse: collapse;text-align: right\">").append(this.ticket.getTotales().getSubTotalDosDecimales$()).append("</td>");			
			regresar.append("</tr>");			
			
			regresar.append("<tr style=\"border-collapse: collapse;\">");			
			regresar.append("<td style=\"font-size: 12px;width: 70px;max-width: 35px;word-break: break-all;border-collapse: collapse;\"></td>");			
			regresar.append("<td style=\"font-size: 12px;width: 35px; max-width: 80px;border-collapse: collapse;\"></td>");			
			regresar.append("<td style=\"font-size: 12px;width: 55px;max-width: 45px;word-break: break-all;border-collapse: collapse;text-align: right;\">IVA:</td>");			
			regresar.append("<td style=\"font-size: 12px;width: 45px;max-width: 45px;word-break: break-all;border-collapse: collapse;text-align: right\">").append(this.ticket.getTotales().getIvaDosDecimales$()).append("</td>");			
			regresar.append("</tr>");			
			
			regresar.append("<tr style=\"border-collapse: collapse;\">");			
			regresar.append("<td style=\"font-size: 12px;width: 70px;max-width: 35px;word-break: break-all;border-collapse: collapse;\"></td>");			
			regresar.append("<td style=\"font-size: 12px;width: 35px; max-width: 80px;border-collapse: collapse;\"></td>");			
			regresar.append("<td style=\"font-size: 14px;width: 55px;max-width: 45px;word-break: break-all;border-collapse: collapse;text-align: right;font-weight: bold;\">TOTAL:</td>");			
			regresar.append("<td style=\"font-size: 14px;width: 45px;max-width: 45px;word-break: break-all;border-collapse: collapse;text-align: right;font-weight: bold;\">$").append(this.ticket.getTotales().getTotalDosDecimales$()).append("</td>");			
			regresar.append("</tr>");			
			...
			if(this.pago.getEfectivo() > 0){			
				...
				regresar.append("<td style=\"font-size: 12px;width: 70px;max-width: 35px;word-break: break-all;border-collapse: collapse;\"></td>");
				regresar.append("<td style=\"font-size: 12px;width: 35px; max-width: 80px;border-collapse: collapse;\"></td>");
				regresar.append("<td style=\"font-size: 12px;width: 55px;max-width: 45px;word-break: break-all;border-collapse: collapse;text-align: right;\">EFECTIVO:</td>");
				regresar.append("<td style=\"font-size: 12px;width: 45px;max-width: 45px;word-break: break-all;border-collapse: collapse;text-align: right;\">").append(this.pago.getEfectivo()).append("</td>");
				regresar.append("</tr>");
			} // if
			...
			if(this.pago.getCredito()> 0){			
				...
				regresar.append("<td style=\"font-size: 12px;width: 70px;max-width: 35px;word-break: break-all;border-collapse: collapse;\"></td>");
				regresar.append("<td style=\"font-size: 12px;width: 35px; max-width: 80px;border-collapse: collapse;\"></td>");
				regresar.append("<td style=\"font-size: 12px;width: 55px;max-width: 45px;word-break: break-all;border-collapse: collapse;text-align: right;\">CREDITO:<br/>REF ").append(this.pago.getReferenciaCredito()).append("</td>");
				regresar.append("<td style=\"font-size: 12px;width: 45px;max-width: 45px;word-break: break-all;border-collapse: collapse;text-align: right;\">").append(this.pago.getCredito()).append("</td>");
				regresar.append("</tr>");
			} // if
			...
			if(this.pago.getTransferencia()> 0){			
				...
				regresar.append("<td style=\"font-size: 12px;width: 70px;max-width: 35px;word-break: break-all;border-collapse: collapse;\"></td>");
				regresar.append("<td style=\"font-size: 12px;width: 35px; max-width: 80px;border-collapse: collapse;\"></td>");
				regresar.append("<td style=\"font-size: 12px;width: 55px;max-width: 45px;word-break: break-all;border-collapse: collapse;text-align: right;\">TRANSF:<br/>REF ").append(this.pago.getReferenciaTransferencia()).append("</td>");
				regresar.append("<td style=\"font-size: 12px;width: 45px;max-width: 45px;word-break: break-all;border-collapse: collapse;text-align: right;\">").append(this.pago.getTransferencia()).append("</td>");
				regresar.append("</tr>");
			} // if
			...
			if(this.pago.getCheque()> 0){			
				...
				regresar.append("<td style=\"font-size: 12px;width: 70px;max-width: 35px;word-break: break-all;border-collapse: collapse;\"></td>");
				regresar.append("<td style=\"font-size: 12px;width: 35px; max-width: 80px;border-collapse: collapse;\"></td>");
				regresar.append("<td style=\"font-size: 12px;width: 55px;max-width: 45px;word-break: break-all;border-collapse: collapse;text-align: right;\">CHEQUE:<br/>REF ").append(this.pago.getReferenciaCheque()).append("</td>");
				regresar.append("<td style=\"font-size: 12px;width: 45px;max-width: 45px;word-break: break-all;border-collapse: collapse;text-align: right;\">").append(this.pago.getCheque()).append("</td>");
				regresar.append("</tr>");
			} // if
			...
			regresar.append("<td style=\"font-size: 12px;width: 70px;max-width: 35px;word-break: break-all;border-collapse: collapse;\"></td>");
			regresar.append("<td style=\"font-size: 12px;width: 35px; max-width: 80px;border-collapse: collapse;\"></td>");
			regresar.append("<td style=\"font-size: 14px;width: 55px;max-width: 45px;word-break: break-all;border-collapse: collapse;text-align: right;font-weight: bold;\">CAMBIO:</td>");
			regresar.append("<td style=\"font-size: 14px;width: 45px;max-width: 45px;word-break: break-all;border-collapse: collapse;text-align: right;font-weight: bold;\">").append(this.pago.getCambio$()).append("</td>");
	...
	private String toVendedor() throws Exception{
		...
		try {
			...
			regresar.append("<p style=\"width: 290px;font-size: 13px;border-top: 1px solid black;border-collapse: collapse;\">");
	...
	private String toFooter(){
		...
		try {
			...
			regresar= new StringBuilder();
			regresar.append("<p style=\"width: 290px;text-align: center;align-content: center;font-size: 14px;border-top: 1px solid black;border-collapse: collapse;\">");
			regresar.append("<br/>¡").append(descripcion).append("!");
			regresar.append("</p>");
			regresar.append("<p style=\"width: 290px;text-align: center;align-content: center;font-size: 12px;\">");
	...
	private String toImage(){
		StringBuilder regresar= null;
		try {
			regresar= new StringBuilder("data:image/png;base64,");
