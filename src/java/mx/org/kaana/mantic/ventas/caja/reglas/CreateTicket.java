...
public class CreateTicket {
	...
	private String toHeader(){
		...
		try {
			...
			regresar.append("<td><p style=\"text-align: center;align-content: center;font-family: sans-serif;font-size: 14px;\">").append(this.principal.getTitulo()).append("<br/>").append(ticket).append("</p></td>");
		...
		try {
			...
			for(Articulo articulo : this.ticket.getArticulos()){
				if(articulo.isValid()){
					...
					regresar.append("<tbody>");
					regresar.append("<tr style=\"border-top: 1px solid black;border-collapse: collapse;\">");
					regresar.append("<td style=\"font-family: sans-serif;font-size: 12px;width: 80px; max-width: 80px;border-top: 1px solid black;border-collapse: collapse;\">").append("</td>");
					regresar.append("<td style=\"font-family: sans-serif;font-size: 12px;width: 35px;max-width: 35px;word-break: break-all;border-top: 1px solid black;border-collapse: collapse;text-align: center\">").append(pivote.getCantidad()).append("</td>");
					regresar.append("<td style=\"font-family: sans-serif;font-size: 12px;width: 35px;max-width: 45px;word-break: break-all;border-top: 1px solid black;border-collapse: collapse;text-align: right\">").append(Numero.formatear(Numero.NUMERO_CON_DECIMALES, pivote.getPrecio())).append("</td>");
					regresar.append("<td style=\"font-family: sans-serif;font-size: 12px;width: 55px;max-width: 45px;word-break: break-all;border-top: 1px solid black;border-collapse: collapse;text-align: right\">").append(pivote.getImporte()).append("</td>");
					regresar.append("</tr>");
					regresar.append("</tbody>");
					regresar.append(toFinishTable());
				} // if
