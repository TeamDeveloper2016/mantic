...
public class CreateTicket {
	...
	private String toEncabezado(){
		...
		try {
			...
			regresar.append("<td><p style=\"text-align: justify;align-content: center;font-size: 10px;\">").append(this.principal.getTitulo()).append("<br/>").append(this.principal.getNombre()).append("</p></td>");
	...
	private String toNoTicket(){
		...
		try {
			regresar= new StringBuilder();
			regresar.append("<p style=\"width: 200px;text-align: center;align-content: center;font-size: 12px;font-weight: bold\">TICKET No:").append(((TicketVenta)this.ticket.getOrden()).getTicket()).append("</p>");
		} // try
		catch (Exception e) {			
			throw e;
		} // catch		
	...
	private String toPagos(){
		...
		try {
			...
			if(this.pago.getCredito()> 0){			
				...
				regresar.append("<td style=\"font-size: 8px;width: 70px;max-width: 35px;word-break: break-all;border-collapse: collapse;\"></td>");
				regresar.append("<td style=\"font-size: 8px;width: 35px; max-width: 80px;border-collapse: collapse;\"></td>");
				regresar.append("<td style=\"font-size: 8px;width: 55px;max-width: 45px;word-break: break-all;border-collapse: collapse;text-align: right;\">CREDITO:</td>");
			...
			if(this.pago.getTransferencia()> 0){			
				...
				regresar.append("<td style=\"font-size: 8px;width: 70px;max-width: 35px;word-break: break-all;border-collapse: collapse;\"></td>");
				regresar.append("<td style=\"font-size: 8px;width: 35px; max-width: 80px;border-collapse: collapse;\"></td>");
				regresar.append("<td style=\"font-size: 8px;width: 55px;max-width: 45px;word-break: break-all;border-collapse: collapse;text-align: right;\">TRANSFERENCIA:</td>");
			...
			if(this.pago.getCheque()> 0){			
				...
				regresar.append("<td style=\"font-size: 8px;width: 70px;max-width: 35px;word-break: break-all;border-collapse: collapse;\"></td>");
				regresar.append("<td style=\"font-size: 8px;width: 35px; max-width: 80px;border-collapse: collapse;\"></td>");
				regresar.append("<td style=\"font-size: 8px;width: 55px;max-width: 45px;word-break: break-all;border-collapse: collapse;text-align: right;\">CHEQUE:</td>");
