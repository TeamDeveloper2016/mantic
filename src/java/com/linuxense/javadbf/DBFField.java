...
public class DBFField {
  ...
  private static final Log LOG= LogFactory.getLog(DBFField.class);
  ...
  */
  ...
  public boolean equals(Object o) {
    ...
    if ( (o != null) && (o instanceof DBFField) ) {
      DBFField d = (DBFField) o;
      if ( (fieldName == d.fieldName) && (dataType == d.dataType) &&
      (fieldLength == d.fieldLength) && (decimalCount == d.decimalCount ) ) {
        result = true;
      }
     }
     return result;
  ...
  public int hashCode() {
    return (dataType ^ fieldLength ^ decimalCount);
  }
