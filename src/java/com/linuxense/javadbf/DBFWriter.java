...
public class DBFWriter extends DBFBase {
  ...
  */
  ...
  private byte[] cambiarCodigos(byte[] byte_array) {
    for(int x= 0; x< byte_array.length; x++) {
    switch(byte_array[x]) {
     case -47: // Ñ
      byte_array[x]= (byte)0xA5;
      break;
     case -15: // ñ
            byte_array[x]= (byte)0xA4;
      break;
     case -63: // �?
            byte_array[x]= (byte)0xA0;
      break;
     case -31: // á
            byte_array[x]= (byte)0xA0;
      break;
     case -55: // É
            byte_array[x]= (byte)0x90;
      break;
     case -23: // é
            byte_array[x]= (byte)0x82;
      break;
     case -51: // �?
            byte_array[x]= (byte)0xA1;
      break;
     case -19: // í
            byte_array[x]= (byte)0xA1;
      break;
     case -45: // Ó
            byte_array[x]= (byte)0xA2;
      break;
     case -13: // ó
            byte_array[x]= (byte)0xA2;
      break;
     case -38: // Ú
            byte_array[x]= (byte)0xA3;
      break;
     case -6:  // ú
            byte_array[x]= (byte)0xA3;
      break;
     case -4:  // Ü
            byte_array[x]= (byte)0x9A;
      break;
     case -36: // ü
            byte_array[x]= (byte)0x81;
      break;
    } // switch   
    } // for
    return byte_array;
      ...
      switch( this.header.fieldArray[j].getDataType()) {
        case 'C':
	        if( objectArray[j] != null) {
	          ...
	          dataOutput.write(cambiarCodigos(Utils.textPadding( str_value, characterSetName, this.header.fieldArray[j].getFieldLength())));
                }else {
