...
class DBFHeader {
  ...
  private static final Log LOG= LogFactory.getLog(DBFHeader.class);
  ...
  void read( DataInput dataInput) throws IOException {
    ...
    //LOG.info( "Number of fields: " + fieldArray.length);
  }
  ...
  void write( DataOutput dataOutput) throws IOException {
    ...
    //LOG.info( "Number of records in O/S: " + numberOfRecords);
    ...
    for( int i=0; i<fieldArray.length; i++) {
      //LOG.info( "Length: " + fieldArray[i].getFieldLength());
